...
#define PASSWORD "D@12345#" // Put your wifi password here
#define TOKEN "BBFF-jAtc2EO75K3NRhttEF7Pl33Zp2ANgo" // Put your Ubidots' TOKEN
#define MQTT_CLIENT_NAME "e@344567rd" // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
  ...
  if (data[0] == 0x7E)
  {
    ...
    if (data[15] == 0x7F) /////// to check if the recive data is correct
    {
      if (data[22] == 0x08) //////// make sure the sensor type is correct
      {
        ...
        dtostrf(rms_y, 4, 2, str_sensorRmsz);
      }
    }
    else
    {
    ...
    sprintf(payload, "%s {\"value\": %s", payload,  str_sensorRmsz); // Adds the value
    sprintf(payload, "%s } }", payload); // Closes the dictionary brackets
